...
import { getPossiblePawnMoves, bishopMove, kingMove, knightMove, pawnMove, queenMove, rookMove, getPossibleKnightMoves, getPossibleBishopMoves, getPossibleRookMoves, getPossibleQueenMoves, getPossibleKingMoves } from "./Rules/index.ts";
